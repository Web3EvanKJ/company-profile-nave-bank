      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="p-6 rounded-2xl shadow bg-gray-50 dark:bg-gray-900 text-center">
            <CreditCard className="mx-auto h-10 w-10 text-green-600 mb-4" />
          ...
          <div className="p-6 rounded-2xl shadow bg-gray-50 dark:bg-gray-900 text-center">
            <PiggyBank className="mx-auto h-10 w-10 text-green-600 mb-4" />
          ...
          <div className="p-6 rounded-2xl shadow bg-gray-50 dark:bg-gray-900 text-center">
            <Briefcase className="mx-auto h-10 w-10 text-green-600 mb-4" />
          ...
          <div className="p-6 rounded-2xl shadow bg-gray-50 dark:bg-gray-900 text-center">
            <Smartphone className="mx-auto h-10 w-10 text-green-600 mb-4" />
          ...
          <div className="p-6 rounded-2xl shadow bg-gray-50 dark:bg-gray-900 text-center">
            <Globe className="mx-auto h-10 w-10 text-green-600 mb-4" />
